...
/**
 * I/O related utility methods. We should think of a better location for these
 * methods.
 *
...
public class IOUtil {
	...
	/**
	 * Gets the environment of the current process. Works with Java 1.4 as well as
	 * 1.5+.
	 *
	...
	/**
	 * Returns the value of an environment variable. This method is here so we don't
	 * get an exception when calling <tt>System.getenv()</tt> in Java 1.4 (which we
	 * support).
	 *
	 ...
	 *              containing variable names and odd indices containing the
	 *              variable values.
	 ...
	 *
	 * @param p      The process.
	 * @param stdout A buffer in which to put stdout, or <code>null</code> if you
	 *               don't want to keep it.
	 * @param stderr A buffer in which to keep stderr, or <code>null</code> if you
	 *               don't want to keep it.
