...
public class LanguageSupportFactory implements PropertyChangeListener {
	...
	/**
	 * Client property set on RSyntaxTextAreas that points to the current language
	 * support for that text area.
	 */
	...
	/**
	 * Adds language support for a language. This is a hook for applications using
	 * this library to add language support for custom languages.
	 *
	 ...
	 * @return The language support, or <code>null</code> if none is registered for
	...
	/**
	 * Listens for RSyntaxTextAreas to change what language they're highlighting, so
	 * language support can be updated appropriately.
	 *
	 * @param e The event.
	 */
	@Override
	...
	/**
	 * Registers an RSyntaxTextArea to receive language support. The text area will
	 * get support for the currently highlighted language, and if it changes what
	 * language it is highlighting, the support will change as appropriate.
	 *
