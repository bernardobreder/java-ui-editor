/*
 * 12/04/2013 Copyright (C) 2013 Robert Futrell robert_futrell at users.sourceforge.net
...
class ColorCompletionGenerator implements CompletionGenerator {
	...
	private static final List<Completion> createDefaults(CompletionProvider provider) {
		...
		completions.add(new ColorTemplateCompletion(provider, "rgb", "rgb(${red}, ${green}, ${blue})${cursor}",
				"rgb(r, g, b)"));
