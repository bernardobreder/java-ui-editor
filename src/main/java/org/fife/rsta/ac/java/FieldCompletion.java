 ...
 * source, such as the source in an <tt>RSyntaxTextArea</tt>, or in a loose file
 * on disk.</li>
 * </ul>
 *
...
class FieldCompletion extends AbstractJavaSourceCompletion implements MemberCompletion {
	...
	/**
	 * The relevance of fields. This allows fields to be "higher" in the completion
	 * list than other types.
	 */
