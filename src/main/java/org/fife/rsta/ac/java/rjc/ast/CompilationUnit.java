...
public class CompilationUnit extends AbstractASTNode implements TypeDeclarationContainer {
	 ...
	 *         <code>null</code> if the offset is outside of any type declaration
	 *         (such as in the import statements, etc.).
	...
	/**
	 * TODO: Return range for more instances than just class methods. Also handle
	 * child TypeDeclarations.
	 *
	 * @param offs
	...
	/**
	 * Returns the import declarations of this compilation unit. This is a copy of
	 * the list of imports, but the actual individual {@link ImportDeclaration}s are
	 * not copies, so modifying them will modify this compilation unit!
	 *
