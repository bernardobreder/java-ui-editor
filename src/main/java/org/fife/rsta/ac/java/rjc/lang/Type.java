...
public class Type {
	...
	/*
	 * MethodDeclaratorRest allows bracket pairs after its FormalParameters, which
	 * increment the array depth of the return type.
	 */
	...
	public boolean isBasicType() {
		...
		if (!isArray() && identifiers.size() == 1 && typeArguments.get(0) == null) {
			...
			basicType = "byte".equals(str) || "float".equals(str) || "double".equals(str) || "int".equals(str)
					|| "short".equals(str) || "long".equals(str) || "boolean".equals(str);
		}
		return basicType;
	}
