...
/**
 * Object used during copy/paste and DnD operations to represent styled text. It
 * can return the text being moved as HTML, RTF or plain text. This class is
 * basically the same as <code>java.awt.datatransfer.StringSelection</code>,
 * except that it can also return the text in a couple of styled text formats.
 *
...
class StyledTextTransferable implements Transferable {
	 ...
	 */
	private static final DataFlavor[] FLAVORS = { DataFlavor.fragmentHtmlFlavor, new DataFlavor("text/rtf", "RTF"),
