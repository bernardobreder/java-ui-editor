...
public class DocumentReader extends Reader {
	...
	/**
	 * Marks the present position in the stream. Subsequent calls to <code>reset()</code> will
	...
	/**
	 * Tells whether this reader supports the <code>mark</code> operation. This always returns
	 * <code>true</code> for <code>DocumentReader</code>.
	 */
	@Override
	...
	/**
	 * Read <code>array.length</code> characters from the beginning of the document into
	 * <code>array</code>.
	 *
	 ...
	 * @return The number of characters read, or <code>-1</code> if the end of the stream (document)
	 *         has been reached.
	 */
	@Override
	 ...
	 *
	 * @return <code>true</code> if the next read operation will return without blocking.
	 */
	@Override
	 ...
	 * If the stream has not been marked, then move it to the beginning of the document.
	 */
	@Override
	public void reset() {
		if (mark == -1) {
	...
	/**
	 * Move to the specified position in the document. If <code>pos</code> is greater than the
	 * document's length, the stream's position is moved to the end of the document.
	 *
