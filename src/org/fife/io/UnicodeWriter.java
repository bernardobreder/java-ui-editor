 ...
 * preceded by the proper Unicode BOM. If it is any other encoding, this class behaves just like
...
public class UnicodeWriter extends Writer {
	...
	/**
	 * If this system property evaluates to "<code>false</code>", ignoring case, files written out
	 * as UTF-8 will not have a BOM written for them. Otherwise (even if the property is not set),
	 * UTF-8 files will have a BOM written.
	 */
