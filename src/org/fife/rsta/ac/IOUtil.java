/*
 * 05/11/2010 Copyright (C) 2010 Robert Futrell robert_futrell at users.sourceforge.net
...
public class IOUtil {
	...
	/**
	 * Returns the value of an environment variable. This method is here so we don't get an
	 * exception when calling <tt>System.getenv()</tt> in Java 1.4 (which we support).
	 *
	 * @param var The environment variable.
	 * @return The value of the variable, or <code>null</code> if it is not defined.
	 */
	...
	/**
	 * Returns the environment of the current process, with some variables possibly
	 * added/overwritten. This method works even with Java 1.4.
	 *
	 * @param toAdd The environment variables to add/overwrite in the returned array. This array
	 *            should have an even length, with even indices containing variable names and odd
	 *            indices containing the variable values.
	 * @return The environment variables. This array's entries will be of the form "
	 *         <code>name=value</code>", so it can be passed directly into
	 ...
	 *
	 * @param p The process.
	 * @param stdout A buffer in which to put stdout, or <code>null</code> if you don't want to keep
	 *            it.
	 * @param stderr A buffer in which to keep stderr, or <code>null</code> if you don't want to
	 *            keep it.
