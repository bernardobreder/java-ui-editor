...
public interface LanguageSupport {
	...
	/**
	 * Client property set on <code>RSyntaxTextArea</code>s referencing the <code>Parser</code>
	 * instance parsing its source code. This will be <code>null</code> if a language support does
	 * not install such a parser.
	 */
	 ...
	 * should automatically appear (if applicable). This parameter is only honored if
	 * {@link #isAutoActivationEnabled()} returns <code>true</code>.
	 *
	...
	/**
	 * Returns the default list cell renderer to install for all text areas with this language
	 * support installed.
	 *
	...
	/**
	 * REturns whether the description window is also shown when the completion list is displayed,
	 * for editors of this language.
	 *
	...
	/**
	 * Returns whether auto-completion is enabled for this language. If this value is
	 * <code>false</code>, then <code>ctrl+space</code> will do nothing.
	 *
	...
	/**
	 * Returns whether parameter assistance is enabled for editors of this language. Note that some
	 * language do not support parameter assistance at all; in those cases, this parameter does
	 * nothing.
	 *
	 * @return Whether parameter assistance is enabled for editors of this language.
	...
	/**
	 * Toggles whether auto-completion is enabled for this language. If this is set to
	 * <code>false</code>, then <code>ctrl+space</code> will do nothing.
	 *
	...
	/**
	 * Sets the default list cell renderer to install for all text areas with this language support
	 * installed. This renderer will be shared amongst all text areas.
	 *
	 * @param r The renderer. If this is <code>null</code>, a default will be used.
	...
	/**
	 * Toggles whether the description window should also be shown when the completion list is
	 * displayed, for editors of this language.
	 *
