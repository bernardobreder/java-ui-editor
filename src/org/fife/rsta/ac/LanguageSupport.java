...
public interface LanguageSupport {
	 ...
	 * completion popup should automatically appear (if applicable). This parameter
	 * is only honored if {@link #isAutoActivationEnabled()} returns
	 * <code>true</code>.
	 *
	...
	/**
	 * REturns whether the description window is also shown when the completion list
	 * is displayed, for editors of this language.
	 *
	...
	/**
	 * Returns whether auto-completion is enabled for this language. If this value
	 * is <code>false</code>, then <code>ctrl+space</code> will do nothing.
	 *
	 ...
	 * Note that some language do not support parameter assistance at all; in those
	 * cases, this parameter does nothing.
	 *
	...
	/**
	 * Toggles whether auto-completion is enabled for this language. If this is set
	 * to <code>false</code>, then <code>ctrl+space</code> will do nothing.
	 *
	...
	/**
	 * Sets the default list cell renderer to install for all text areas with this
	 * language support installed. This renderer will be shared amongst all text
	 * areas.
	 *
