 ...
 * Different languages may have varying levels of "support."
 *
...
public class LanguageSupportFactory implements PropertyChangeListener {
	...
	/**
	 * Client property set on RSyntaxTextAreas that points to the current language support for that
	 * text area.
	 */
	...
	/**
	 * Adds language support for a language. This is a hook for applications using this library to
	 * add language support for custom languages.
	 *
	 * @param style The language to add support for. This should be one of the values defined in
	 *            {@link SyntaxConstants}. Any previous language support for this language is
	 *            removed.
	...
	private void createSupportMap() {
		...
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_C, prefix + "c.CLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_CSS, prefix + "css.CssLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_GROOVY, prefix + "groovy.GroovyLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_HTML, prefix + "html.HtmlLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_JAVA, prefix + "java.JavaLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_JAVASCRIPT, prefix + "js.JavaScriptLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_JSP, prefix + "jsp.JspLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_PERL, prefix + "perl.PerlLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_PHP, prefix + "php.PhpLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_UNIX_SHELL, prefix + "sh.ShellLanguageSupport");
		addLanguageSupport(SyntaxConstants.SYNTAX_STYLE_XML, prefix + "xml.XmlLanguageSupport");
	 ...
	 * @return The language support, or <code>null</code> if none is registered for the language
	 *         specified.
	 */
	...
	/**
	 * Listens for RSyntaxTextAreas to change what language they're highlighting, so language
	 * support can be updated appropriately.
	 *
	 * @param e The event.
	 */
	@Override
	...
	/**
	 * Registers an RSyntaxTextArea to receive language support. The text area will get support for
	 * the currently highlighted language, and if it changes what language it is highlighting, the
	 * support will change as appropriate.
	 *
	...
	public void unregister(RSyntaxTextArea textArea) {
		...
		textArea.removePropertyChangeListener(RSyntaxTextArea.SYNTAX_STYLE_PROPERTY, this);
	}
