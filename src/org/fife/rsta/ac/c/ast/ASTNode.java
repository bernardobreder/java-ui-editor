 ...
 */
package org.fife.rsta.ac.c.ast;
...
public interface ASTNode {
	...
	/**
	 * Returns the "name" of this node. This will be the name of the method, the name of the member
	 * or local variable, etc. For {@link CodeBlock}s it will be {@link CodeBlock#NAME}.
	 * <p>
	 * Note that this may not be unique. For example, a class with an overloaded method will have
	 * multiple methods with the same "name," just with different signatures.
	 *
