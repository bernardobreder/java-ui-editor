 ...
 * <ul>
 * <li>A {@link FieldInfo} instance, which is loaded by parsing a class file. This is used when this
 * completion represents a field found in a compiled library.</li>
 * <li>A {@link Field} instance, which is created when parsing a Java source file. This is used when
 * the completion represents a field found in uncompiled source, such as the source in an
...
class FieldCompletion extends AbstractJavaSourceCompletion implements MemberCompletion {
	...
	/**
	 * The relevance of fields. This allows fields to be "higher" in the completion list than other
	 * types.
	 */
