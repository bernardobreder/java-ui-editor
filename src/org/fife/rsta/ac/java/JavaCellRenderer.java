...
/**
 * Cell renderer for Java auto-completion. This renderer attempts to be fast due to the possibility
 * of many (100+) auto-completions dynamically generated for large Java classes. Using Swing's HTML
 * support is simply too slow (see {@link CompletionCellRenderer}).
 * <p>
...
public class JavaCellRenderer extends DefaultListCellRenderer {
	...
	/**
	 * This is used instead of jsc for "incomplete" stuff, like classes, interfaces, etc. read from
	 * jars (don't yet read the class in, for example).
	 */
	...
	/**
	 * Sets whether to display "simple" text about the completion - just the name, no type
	 * information, etc. The default value is <code>false</code>.
	 *
