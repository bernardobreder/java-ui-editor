...
public class JavaParamListCellRenderer extends JavaCellRenderer {
	 ...
	 * {@link JavaCellRenderer} doesn't override this method, because it doesn't use the cells to
	 * dictate the preferred size of the list, due to the large number of completions it shows at a
	 * time.
	 */
	@Override
