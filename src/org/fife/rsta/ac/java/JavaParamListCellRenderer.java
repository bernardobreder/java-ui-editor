/*
 * 12/16/2010 Copyright (C) 2010 Robert Futrell robert_futrell at users.sourceforge.net
...
public class JavaParamListCellRenderer extends JavaCellRenderer {
	...
	/**
	 * Returns the preferred size of a particular cell. Note that the parent class
	 * {@link JavaCellRenderer} doesn't override this method, because it doesn't use
	 * the cells to dictate the preferred size of the list, due to the large number
	 * of completions it shows at a time.
	 */
	@Override
