/*
 * 06/25/2012 Copyright (C) 2012 Robert Futrell robert_futrell at users.sourceforge.net
...
public class JavaTemplateCompletion extends TemplateCompletion implements JavaSourceCompletion {
	...
	public JavaTemplateCompletion(CompletionProvider provider, String inputText, String definitionString,
			String template) {
