 ...
 * of two sources:
 * <ul>
 * <li>A {@link MethodInfo} instance, which is loaded by parsing a class file.
 * This is used when this completion represents a method found in a compiled
 * library.</li>
 ...
 * uncompiled source, such as the source in an <tt>RSyntaxTextArea</tt>, or in a
 * loose file on disk.</li>
 * </ul>
 *
...
class MethodCompletion extends FunctionCompletion implements MemberCompletion {
	...
	/**
	 * Creates a completion for a method discovered when parsing a compiled class
	 * file.
	 *
	 * @param provider
