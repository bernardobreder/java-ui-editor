 ...
 * <ul>
 * <li>A {@link MethodInfo} instance, which is loaded by parsing a class file. This is used when
 * this completion represents a method found in a compiled library.</li>
 * <li>A {@link Method} instance, which is created when parsing a Java source file. This is used
 * when the completion represents a method found in uncompiled source, such as the source in an
...
class MethodCompletion extends FunctionCompletion implements MemberCompletion {
	...
	/**
	 * The relevance of methods. This allows methods to be "higher" in the completion list than
	 * other types.
	 */
	...
	private String getCompareString() {
		...
		/*
		 * This string compares the following parts of methods in this order, to optimize sort order
		 * in completion lists. 1. First, by name 2. Next, by number of parameters. 3. Finally, by
		 * parameter type.
		 */
