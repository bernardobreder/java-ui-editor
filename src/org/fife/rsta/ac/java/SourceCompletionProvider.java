...
class SourceCompletionProvider extends DefaultCompletionProvider {
	...
	/**
	 * Adds completions for accessible methods and fields of super classes. This is
	 * only called when the caret is inside of a class. TODO: Handle accessibility
	 * correctly!
	 *
	 * @param set
	 ...
	 * @param typeParamMap A mapping of type parameters to type arguments for the
	 *                     object whose fields/methods/etc. are currently being
	 *                     code-completed.
	 */
	...
	/**
	 * Adds completions for all methods and public fields of a local variable. This
	 * will add nothing if the local variable is a primitive type.
	 *
	 ...
	 *         <code>cf</code> represents <code>java.lang.Object</code> (or if the
	 *         super class could not be determined).
	 */
	 ...
	 *
	 * @param info The jar to add. If this is <code>null</code>, then the current
	 *             JVM's main JRE jar (rt.jar, or classes.jar on OS X) will be
	 *             added. If this jar has already been added, adding it again will
	...
	/**
	 * Checks whether the user is typing a completion for a String member after a
	 * String literal.
	 *
	 ...
	 * @return Whether the user is indeed typing a completion for a String literal
	 *         member.
	 */
	 ...
	 *
	 * @param type The type of a variable/field/etc. whose fields/methods/etc. are
	 *             being code completed, as declared in the source. This includes
	 *             type arguments.
	 ...
	 *         {@link #addJar(LibraryInfo)}. If there are no jars on the "build
	...
	/**
	 * Loads completions based on the current caret location in the source. In other
	 * words:
	 * <ul>
	 * <li>If the caret is anywhere in a class, the names of all methods and fields
	 * in the class are loaded. Methods and fields in super classes are also loaded.
	 * TODO: Get super methods/fields added correctly by access!
	 ...
	 * declaration. This method checks if the caret is in a child type declaration
	...
	/**
	 * Loads completions for the text at the current caret position, if there is a
	 * "prefix" of chars and at least one '.' character in the text up to the caret.
	 * This is currently very limited and needs to be improved.
	 *
	 * @param cu
	 * @param alreadyEntered
	 * @param retVal
