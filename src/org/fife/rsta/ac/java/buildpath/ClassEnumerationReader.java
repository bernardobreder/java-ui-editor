 ...
 * <ul>
 * <li>Lines that start with a "<code>-</code>" denote a fully-qualified class,
 * interface, or enum name.
 * <li>Lines following a line starting with "<code>-</code>" are simply a class,
 * interface, or enum name, and are assumed to be in the same package as the
 * previous class on the "<code>-</code>" line.
