...
/**
 * The <code>SourceFile</code> attribute, an optional fixed-length attribute in the attributes table
 * of a {@link ClassFile}. There can be no more than one <code>SourceFile</code> attribute for a
 * given <code>ClassFile</code>.
 *
...
public class SourceFile extends AttributeInfo {
	...
	/**
	 * Index into the constant pool of a {@link ConstantUtf8Info} structure representing the name of
	 ...
	 * @param sourceFileIndex Index into the constant pool of a {@link ConstantUtf8Info} structure
