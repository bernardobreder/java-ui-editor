...
public class ConstantClassInfo extends ConstantPoolInfo {
	 ...
	 * <code>CONSTANT_Utf8_info</code> structure representing a valid, fully-qualified class or
	 ...
	 * Constructor.
	 *
	 * @param nameIndex The index into the constant pool containing a {@link ConstantUtf8Info}
	 *            representing the fully-qualified class or interface name, encoded in internal
	 *            form.
	 */
	...
	/**
	 * Returns the index into the constant pool table for a <code>ConstantUtf8Info</code> structure
