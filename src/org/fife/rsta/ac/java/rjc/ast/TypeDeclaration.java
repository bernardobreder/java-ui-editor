...
public interface TypeDeclaration extends ASTNode, TypeDeclarationContainer {
	...
	/**
	 * Returns the child type declaration of this one that contains the specified
	 * offset, if any.
	 *
	 * @param offs The offset.
	 * @return The type declaration, or <code>null</code> if the offset is outside
	 *         of any child type declaration.
	 */
	...
	/**
	 * Returns an iterator over all members of this type. Note that an exception may
	 * be thrown if a method is added to this type while this iterator is being
	 * used.
	 *
	 * @return The iterator.
	 * @see #getMethodIterator()
	...
	/**
	 * Returns all methods declared in this type with the given name. Does not check
	 * for methods with this name in subclasses.
	 *
