...
public interface TypeDeclaration extends ASTNode, TypeDeclarationContainer {
	 ...
	 * @return The type declaration, or <code>null</code> if the offset is outside of any child type
	 *         declaration.
	 */
	...
	/**
	 * Returns an iterator over all members of this type. Note that an exception may be thrown if a
	 * method is added to this type while this iterator is being used.
	 *
	 * @return The iterator.
	 * @see #getMethodIterator()
	 */
	...
	/**
	 * Returns all methods declared in this type with the given name. Does not check for methods
	 * with this name in subclasses.
	 *
	 ...
	 *
	 * @return The modifier list. This may be <code>null</code> if no modifiers were specified.
	 */
	 ...
	 *
	 * @param fullyQualified Whether the name returned should be fully qualified.
	 ...
	 *
	 * @return The parent type declaration, or <code>null</code> if there isn't one.
