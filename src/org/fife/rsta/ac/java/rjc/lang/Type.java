...
public class Type {
	 ...
	 * @param typeArgs The type arguments for the identifier. This may be <code>null</code> or an
	 ...
	 *
	 * @param fullyQualified Whether the returned value should be fully qualified.
	 * @param addTypeArgs Whether type arguments should be at the end of the returned string, if
	 *            any.
	...
	/*
	 * MethodDeclaratorRest allows bracket pairs after its FormalParameters, which increment the
	 * array depth of the return type.
	 */
