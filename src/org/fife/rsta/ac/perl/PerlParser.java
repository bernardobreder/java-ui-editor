/*
 * 05/10/2010 Copyright (C) 2010 Robert Futrell robert_futrell at users.sourceforge.net
...
/**
 * Parses Perl code in an <tt>RSyntaxTextArea</tt>.
 * <p>
...
public class PerlParser extends AbstractParser {
	...
	public ParseResult parse(RSyntaxDocument doc, String style) {
		...
		try {
			...
			t.start();
			PerlOutputCollector stderr = new PerlOutputCollector(p.getErrorStream(), this, result, root);
	 ...
	 *
	 * @param override The value, or <code>null</code> to use the system default.
