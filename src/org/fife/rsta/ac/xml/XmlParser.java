 ...
 * fired. Listeners can check the new value of the property for an
 * {@link XmlTreeNode} that represents the root of a tree structure modeling the
 * XML content in the text area. Note that the <code>XmlTreeNode</code> may be
 * incomplete if there were parsing/syntax errors (it will usually be complete
 * "up to" the error in the content).
 * <p>
...
public class XmlParser extends AbstractParser {
	 ...
	 * representing the root of a tree modeling the XML content. The "old value" is
	...
	/**
	 * Adds a listener to this parser. Typically you'd want to register a listener
	 * on the {@link #PROPERTY_AST} property.
	 *
	...
	/**
	 * Sets how validation will be done by this parser. This can be used to set up
	 * either DTD or Schema validation.
	 *
