/*
 * 09/20/2013 CollapsibleSectionPanel - A panel that can show or hide its contents. This library is
...
/**
 * A panel that can show or hide contents anchored to its bottom via a shortcut. Those contents
 * "slide" in, since today's applications are all about fancy smancy animations.
 *
...
public class CollapsibleSectionPanel extends JPanel {
	 ...
	 * {@link #showBottomComponent(JComponent)} directly. Any previously displayed bottom component
	 * will be hidden.
	 *
	...
	/**
	 * Adds a "bottom component" and binds its display to a key stroke. Whenever that key stroke is
	 * typed in a descendant of this panel, this component will be displayed. You can also display
	 * it programmatically by calling {@link #showBottomComponent(JComponent)}.
	 *
	 * @param ks The key stroke to bind to the display of the component. If this parameter is
	 *            <code>null</code>, this method behaves exactly like the
	 *            {@link #addBottomComponent(JComponent)} overload.
	 * @param comp The component to add.
	 * @return An action that displays this component. You can add this action to a
	 *         <code>JMenu</code>, for example, to alert the user of a way to display the component.
	 ...
	 *
	 * @return The currently displayed bottom component. This will be <code>null</code> if no bottom
	...
	/**
	 * Sets the amount of time, in milliseconds, it should take for a "collapsible panel" to show or
	 * hide. The default is <code>120</code>.
	 *
	...
	/**
	 * Displays a new "bottom" component. If a component is currently displayed at the "bottom," it
	 * is hidden.
	 *
