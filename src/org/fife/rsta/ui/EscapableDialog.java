/*
 * 08/06/2012 EscapableDialog.java - A dialog that can be dismissed via the Escape key. This library
 * is distributed under a modified BSD license. See the included RSTAUI.License.txt file for
 * details.
 */
...
/**
 * A dialog that closes itself when the Escape key is pressed. Subclasses can extend the
 * {@link #escapePressed()} method and provide custom handling logic (parameter validation, custom
 * closing, etc.).
 *
...
public abstract class EscapableDialog extends JDialog {
	...
	/**
	 * Called when the Escape key is pressed in this dialog. Subclasses can override to handle any
	 * custom "Cancel" logic. The default implementation hides the dialog (via
