/*
 * 11/13/2003 GoToDialog.java - A dialog allowing you to skip to a specific line number. This
 * library is distributed under a modified BSD license. See the included RSTAUI.License.txt file for
 * details.
 */
...
public class GoToDialog extends EscapableDialog {
	...
	/**
	 * Called when they've clicked OK or pressed Enter; check the line number they entered for
	 * validity and if it's okay, close this dialog. If it isn't okay, display an error message.
	 *
	 * @return Whether the line number was valid. In this case, this dialog will be hidden when this
	 *         method returns.
	 */
	...
	/**
	 * Returns a panel containing the OK and Cancel buttons. This panel is added to the bottom of
	 * this dialog. Applications that don't like these buttons right-aligned in the dialog can
	...
	/**
	 * Displays a message to the user that they have entered an invalid line number. The default
	 * implementation displays the error message in a modal. Subclasses that wish to have a slicker
	 * error delivery mechanism can override.
	 */
	protected void displayInvalidLineNumberMessage() {
		JOptionPane.showMessageDialog(this, msg.getString("LineNumberRange") + maxLineNumberAllowed + ".", getErrorDialogTitle(), JOptionPane.ERROR_MESSAGE);
	}
	
	/**
	 * Called when the user clicks Cancel or hits the Escape key. This hides the dialog.
	 */
	@Override
	 ...
	 *
	 * @return The line number the user decided to go to, or <code>-1</code> if the dialog was
	 *         canceled. If valid, this will be 1-based, not 0-based.
	 */
	 ...
	 *
	 * @param title The new title. If this is <code>null</code>, a default value will be used.
	 ...
	 * buttons are enabled if the user is enabling the dialog.
	 */
	@Override
