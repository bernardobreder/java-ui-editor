/*
 * 09/07/2006 SizeGripIcon.java - An icon that paints a size grip. This library is distributed under
 * a modified BSD license. See the included RSTAUI.License.txt file for details.
 */
