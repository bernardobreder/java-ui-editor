/*
 * 09/08/2005 UIUtil.java - Utility methods for org.fife.rsta.ui classes. This library is
 * distributed under a modified BSD license. See the included RSTAUI.License.txt file for details.
 */
...
public class UIUtil {
	...
	/**
	 * Fixes the orientation of the renderer of a combo box. I can't believe Swing standard LaFs
	 ...
	 *
	 * @param parent The container whose layout must be an instance of <code>SpringLayout</code>.
	...
	/**
	 * Returns an empty border of width 5 on all sides. Since this is a very common border in GUI's,
	 * the border returned is a singleton.
	 *
	 * @return The border.
	 */
	...
	/**
	 * Returns a color to use for "error" text in a text field. This will pick red for
	 * dark-text-on-light-background LookAndFeels, and a brighter color for
	...
	/**
	 * This method is ripped off from <code>SpringUtilities.java</code> found on Sun's Java Tutorial
	 * pages. It takes a component whose layout is <code>SpringLayout</code> and organizes the
	 * components it contains into a nice grid. Aligns the first <code>rows</code> *
	 * <code>cols</code> components of <code>parent</code> in a grid. Each component in a column is
	 * as wide as the maximum preferred width of the components in that column; height is similarly
	 ...
	 * <code>getString(textKey) + ".Mnemonic"</code> is defined, it is used as the mnemonic for the
	 * button.
	 *
	...
	/**
	 * Returns an <code>JLabel</code> with the specified text. If another property with name
	 * <code>getString(textKey) + ".Mnemonic"</code> is defined, it is used as the mnemonic for the
	 * label.
	 *
	 * @param msg The resource bundle.
