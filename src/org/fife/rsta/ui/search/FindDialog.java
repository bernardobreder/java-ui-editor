/*
 * 11/14/2003 FindDialog - Dialog for finding text in a GUI. This library is distributed under a
 * modified BSD license. See the included RSTAUI.License.txt file for details.
 */
...
/**
 * A "Find" dialog similar to those found in most Windows text editing applications. Contains many
 ...
 * <p>
 * An application can use a <code>FindDialog</code> as follows. It is suggested that you create an
 * <code>Action</code> or something similar to facilitate "bringing up" the Find dialog. Have the
 * main application contain an object that implements {@link SearchListener}. This object will
 * receive {@link SearchEvent}s of the following types from the Find dialog:
 * <ul>
...
public class FindDialog extends AbstractFindReplaceDialog {
	...
	/**
	 * Listens for the text field gaining focus. All it does is select all text in the combo box's
	 * text area.
	 */
