/*
 * 09/20/2013 FindReplaceButtonsEnableResult - Whether "find" and "replace" buttons should be
 * enabled. This library is distributed under a modified BSD license. See the included
