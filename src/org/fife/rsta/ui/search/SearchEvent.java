/*
 * 09/20/2013 SearchEvent - The event fired for find/replace/mark all operations. This library is
...
/**
 * The event fired whenever a user wants to search for or replace text in a Find or Replace
 * dialog/tool bar.
 *
...
public class SearchEvent extends EventObject {
	...
	public static enum Type {
		...
		/**
		 * The event fired when the user wants to replace all instances of specific text with new
		 * text in the editor.
		 */
		REPLACE_ALL;
