/*
 * 01/03/2009 BasicCompletion.java - A straightforward Completion implementation. This library is
...
/**
 * A straightforward {@link Completion} implementation. This implementation can be used if you have
 * a relatively short number of static completions with no (or short) summaries.
 * <p>
 * This implementation uses the replacement text as the input text. It also includes a
 * "short description" field, which (if non-<code>null</code>), is used in the completion choices
 * list.
 *
...
public class BasicCompletion extends AbstractCompletion {
	 ...
	 *            completion list. This may be <code>null</code>.
	 */
	 ...
	 * @param shortDesc A short description of the completion. This will be displayed in the
	 *            completion list. This may be <code>null</code>.
	 * @param summary The summary of this completion. This should be HTML. This may be
	 *            <code>null</code> .
	 */
	...
	/**
	 * Returns the short description of this completion, usually used in the completion choices
	 * list.
	 *
	...
	/**
	 * Returns a string representation of this completion. If the short description is not
	 * <code>null</code>, this method will return: <code>getInputText() + " - " + shortDesc</code>
