/*
 * 05/11/2012 Copyright (C) 2012 Robert Futrell robert_futrell at users.sourceforge.net
...
/**
 * Passed to {@link ExternalURLHandler}s as a way for them to display a summary for a new completion
 * in response to a link event.
 *
...
public interface DescWindowCallback {
	...
	/**
	 * Callback allowing a new code completion's description to be displayed in the description
	 * window.
	 *
