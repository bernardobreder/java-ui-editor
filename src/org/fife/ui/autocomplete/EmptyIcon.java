...
/**
 * A standard icon that doesn't paint anything. This can be used when some <code>Completion</code>s
 * have icons and others don't, to visually align the text of all completions.
 *
