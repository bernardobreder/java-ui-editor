/*
 * 12/11/2010 ParameterizedCompletion.java - A completion option. This library is distributed under
...
public interface ParameterizedCompletion extends Completion {
	...
	/**
	 * Returns whether a tool tip displaying assistance for each parameter while it is being edited
	 * is appropriate for this completion.
	 *
	...
	public static class Parameter {
		 ...
		 * Constructor.
		 *
		 * @param type The type of this parameter. This may be <code>null</code> for languages
		 *            without specific types, dynamic typing, etc. Usually you'll pass a String for
		 *            this value, but you may pass any object representing a type in your language,
		 *            as long as its <code>toString()</code> method returns a string representation
		 *            of the type.
		 ...
		 *            of the type.
		 * @param name The name of the parameter.
		 * @param endParam Whether this parameter is an "ending parameter;" that is, whether this
		 *            parameter is at a logical "ending point" in the completion text. If the user
		 *            types in a parameter that is an ending point, parameter completion mode
		 *            terminates. Set this to <code>true</code> for a trailing parameter after a
		...
		/**
		 * @return Whether this parameter is an "ending parameter;" that is, whether this parameter
		 *         is at a logical "ending point" in the completion text. If the user types in a
		 *         parameter that is an ending point, parameter completion mode terminates.
		 */
