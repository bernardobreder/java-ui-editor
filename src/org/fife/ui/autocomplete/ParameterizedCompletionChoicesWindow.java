/*
 * 12/11/2010 ParameterizedCompletionChoicesWindow.java - A list of likely choices for a parameter.
...
/**
 * A small popup window offering a list of likely choices for a parameter when the user has
 * code-completed a parameterized completion. For example, if they have just code-completed the C
 * function "<code>fprintf</code>", when entering the file name, this popup might display all local
 * variables of type " <code>char *</code>".
 *
...
public class ParameterizedCompletionChoicesWindow extends JWindow {
	...
	/**
	 * Displays the choices for the specified parameter matching the given text. This will display
	 * or hide this popup window as necessary.
	 *
	 * @param param The index of the parameter the caret is currently in. This may be
	 *            <code>-1</code> if not in a parameter (i.e., on the comma between parameters).
	 * @param prefix Text in the parameter before the dot. This may be <code>null</code> to
