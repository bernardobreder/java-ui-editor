/*
 * 12/22/2008 ShorhandCompletion.java - A completion that is shorthand for some other text. This
...
/**
 * A completion where the input text is shorthand for (really, just different than) the actual text
 * to be inserted. For example, the input text " <code>sysout</code>
 * " could be associated with the completion " <code>System.out.println(</code>" in Java.
 *
...
public class ShorthandCompletion extends BasicCompletion {
	...
	/**
	 * If a summary has been set, that summary is returned. Otherwise, the replacement text is
	 * returned.
	 *
	...
	/**
	 * Returns the "body" of the HTML returned by {@link #getSummary()} when no summary text has
	 * been set. This is defined to return the replacement text in a monospaced font.
	 *
