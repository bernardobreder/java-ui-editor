 ...
 * <p>
 * This completion type uses its <tt>shortDescription</tt> property as part of its summary returned
 * by {@link #getSummary()}; for this reason, it may be a little longer (even much longer), if
 * desired, than what is recommended for <tt>BasicCompletion</tt>s (where the
 * <tt>shortDescription</tt> is used in {@link #toString()} for <tt>ListCellRenderers</tt>).
 *
...
public class VariableCompletion extends BasicCompletion {
	 ...
	 * @param type The type of this variable (e.g. "<code>int</code>", " <code>String</code>",
	 *            etc.).
	 */
