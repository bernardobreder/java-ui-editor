...
/**
 * Base class for JFlex-generated token makers. This class attempts to factor out all common code
 * from these classes. Many methods <em>almost</em> could be factored out into this class, but
 * cannot because they reference JFlex variables that we cannot access from this class.
 *
