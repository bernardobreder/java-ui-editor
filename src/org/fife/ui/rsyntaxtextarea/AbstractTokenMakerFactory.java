...
/**
 * Base class for {@link TokenMakerFactory} implementations. A mapping from language keys to the
 * names of {@link TokenMaker} classes is stored.
 *
...
public abstract class AbstractTokenMakerFactory extends TokenMakerFactory {
	 ...
	 * {@link #getTokenMaker(String)} is called with a key defined in this map, a
	 * <code>TokenMaker</code> of the corresponding type is returned.
	 */
	...
	/**
	 * Populates the mapping from keys to instances of <code>TokenMakerCreator</code>s. Subclasses
	 * should override this method and call one of the <code>putMapping</code> overloads to register
