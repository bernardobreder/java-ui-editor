...
/**
 * The default implementation of {@link OccurrenceMarker}. It goes through the document and marks
 * all instances of the specified token.
 *
...
class DefaultOccurrenceMarker implements OccurrenceMarker {
	...
	/**
	 * Highlights all instances of tokens identical to <code>t</code> in the specified document.
	 *
