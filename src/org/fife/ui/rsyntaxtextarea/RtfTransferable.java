/*
 * 07/28/2008 RtfTransferable.java - Used during drag-and-drop to represent RTF text. This library
...
class RtfTransferable implements Transferable {
	 ...
	 */
	private final DataFlavor[] FLAVORS = { new DataFlavor("text/rtf", "RTF"), DataFlavor.stringFlavor };
