...
/**
 * A link generator result that selects a region of text in the text area. This will typically be
 * used by IDE-style applications, to provide support for "linking" the use of a variable in a
 * document to its declaration.
 *
