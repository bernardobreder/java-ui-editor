 ...
 * <code>RSyntaxTextArea</code> has a corresponding <code>Style</code>; this <code>Style</code>
...
public class Style implements Cloneable {
	...
	public boolean equals(Object o2) {
		if (o2 instanceof Style) {
			Style ss2 = (Style) o2;
			if (this.underline == ss2.underline && areEqual(foreground, ss2.foreground) && areEqual(background, ss2.background) && areEqual(font, ss2.font) && areEqual(fontMetrics, ss2.fontMetrics)) {
				return true;
			}
		}
		return false;
	 ...
	 * <p>
	 * This method is implemented, since {@link #equals(Object)} is implemented, to keep FindBugs
	 * happy.
	 *
