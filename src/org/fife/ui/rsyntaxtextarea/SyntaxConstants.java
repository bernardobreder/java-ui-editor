/*
 * 03/08/2004 SyntaxConstants.java - Constants used by RSyntaxTextArea and friends. This library is
 ...
 * {@link RSyntaxTextArea#setSyntaxEditingStyle(String)} to get syntax highlighting.
 * <p>
 * By default, all <code>RSyntaxTextArea</code>s can render all of these languages, but this can be
 * changed (the list can be augmented or completely overwritten) on a per-text area basis. What
 * languages can be rendered is actually managed by the {@link TokenMakerFactory} installed on the
 * text area's {@link RSyntaxDocument}. By default, all <code>RSyntaxDocumenet</code> s have a
 * factory installed capable of handling all of these languages.
 *
