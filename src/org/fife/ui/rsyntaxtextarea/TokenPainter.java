...
/**
 * Renders tokens in an instance of {@link RSyntaxTextArea}. One instance may render tokens
 * "regularly," another may render visible whitespace, for example.
 *
...
interface TokenPainter {
	 ...
	 *            optimizes painting by allowing us to not paint paint when this token is
	...
	/**
	 * Paints this token as it should appear in a selected region of text (assuming painting with a
	 * selection-foreground color is enabled in the parent <code>RSyntaxTextArea</code>).
	 *
	 * @param token The token to render.
	 * @param g The graphics context in which to paint.
	 * @param x The x-coordinate at which to paint.
