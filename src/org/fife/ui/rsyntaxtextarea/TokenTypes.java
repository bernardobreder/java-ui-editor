/*
 * 12/04/2011 TokenTypes.java - All token types supported by RSyntaxTextArea. This library is
 ...
 * <p>
 * Note that all valid token types are &gt;= 0, so extensions of the TokenMaker class are free to
 * internally use all ints &lt; 0 ONLY for "end-of-line" style markers; they are ignored by painting
 * implementations.
 *
...
public interface TokenTypes {
	...
	/**
	 * Tokens of type <code>NULL</code> mark the end of lines with no multi-line token at the end
	 * (such as a block comment in C++).
	 */
