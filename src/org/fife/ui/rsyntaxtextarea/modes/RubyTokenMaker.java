 ...
 * <ul>
 * <li>The generated RubyTokenMaker.java</code> file will contain two definitions of both
...
public class RubyTokenMaker extends AbstractJFlexTokenMaker {
	...
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside an unquoted/double
	 * quoted/backtick EOF heredoc.
	 */
	public static final int INTERNAL_HEREDOC_EOF_UNQUOTED = -1;
	
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside an single quoted EOF
	 * heredoc.
	 */
	public static final int INTERNAL_HEREDOC_EOF_SINGLE_QUOTED = -2;
	
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside an double quoted EOF
	 * heredoc.
	 */
	...
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside an unquoted/double
	 * quoted/backtick EOT heredoc.
	 */
	public static final int INTERNAL_HEREDOC_EOT_UNQUOTED = -4;
	
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside an single quoted EOT
	 * heredoc.
	 */
	public static final int INTERNAL_HEREDOC_EOT_SINGLE_QUOTED = -5;
	
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside an double quoted EOT
	 * heredoc.
	 */
	public static final int INTERNAL_HEREDOC_EOT_DOUBLE_QUOTED = -6;
	
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside a %Q!...! style double
	 * quoted string.
	 */
	...
	/**
	 * Token type specific to RubyTokenMaker; this signals that we are inside a %Q&lt;...&gt; style
