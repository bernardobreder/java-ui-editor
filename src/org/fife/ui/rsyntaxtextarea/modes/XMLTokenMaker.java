...
/*
 * 01/24/2005 XMLTokenMaker.java - Generates tokens for XML syntax highlighting. This library is
...
/**
 * Scanner for XML. This implementation was created using <a href="http://www.jflex.de/">JFlex</a>
 * 1.4.1; however, the generated file was modified for performance. Memory allocation needs to be
 * almost completely removed to be competitive with the handwritten lexers (subclasses of
 ...
 * <ul>
 * <li>The generated <code>XMLTokenMaker.java</code> file will contain two definitions of both
...
public class XMLTokenMaker extends AbstractMarkupTokenMaker {
	...
	private static final String ZZ_ACTION_PACKED_0 = "\5\0\2\1\1\0\2\2\1\3\1\4\1\5\1\6" + "\2\1\1\7\4\1\1\10\2\1\1\11\1\1\1\12" + "\1\13\1\14\2\15\1\16\1\17\1\20\1\21\1\22" + "\1\1\1\23\3\1\1\24\1\25\1\4\1\26\1\6" + "\5\0\1\27\4\0\1\30\1\31\5\0\1\32\1\33" + "\3\0\1\34\1\35\6\0\1\36";
	...
	private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\45\0\112\0\157\0\224\0\271\0\336\0\u0103" + "\0\u0128\0\u014d\0\u0172\0\u0197\0\u01bc\0\u01e1\0\u0206\0\u022b" + "\0\u0172\0\u0250\0\u0275\0\u029a\0\u02bf\0\u0172\0\u02e4\0\u0309" + "\0\u0172\0\u032e\0\u0172\0\u0172\0\u0172\0\u0353\0\u0378\0\u0172" + "\0\u0172\0\u039d\0\u0172\0\u0172\0\u03c2\0\u0172\0\u03e7\0\u040c" + "\0\u0431\0\u0456\0\u047b\0\u04a0\0\u0172\0\u0172\0\u04c5\0\u04ea" + "\0\u050f\0\u0534\0\u0559\0\u0172\0\u057e\0\u05a3\0\u05c8\0\u05ed" + "\0\u0612\0\u0172\0\u0637\0\u065c\0\u0681\0\u06a6\0\u06cb\0\u0172" + "\0\u0172\0\u06f0\0\u0715\0\u073a\0\u075f\0\u0172\0\u0784\0\u07a9" + "\0\u075f\0\u07ce\0\u07f3\0\u0818\0\u0172";
	...
	private static final String ZZ_ATTRIBUTE_PACKED_0 = "\5\0\2\1\1\0\2\1\1\11\5\1\1\11\4\1" + "\1\11\2\1\1\11\1\1\3\11\2\1\2\11\1\1" + "\2\11\1\1\1\11\6\1\2\11\5\0\1\11\4\0" + "\1\1\1\11\5\0\2\11\3\0\1\1\1\11\6\0" + "\1\11";
	...
	/**
	 * Type specific to XMLTokenMaker denoting a line ending with an unclosed double-quote
	 * attribute.
	 */
	public static final int INTERNAL_ATTR_DOUBLE = -1;
	
	/**
	 * Type specific to XMLTokenMaker denoting a line ending with an unclosed single-quote
	 * attribute.
	 */
	public static final int INTERNAL_ATTR_SINGLE = -2;
	
	/**
	 * Token type specific to XMLTokenMaker denoting a line ending with an unclosed XML tag; thus a
	 * new line is beginning still inside of the tag.
	 */
	...
	/**
	 * Token type specific to XMLTokenMaker denoting a line ending with an unclosed, locally-defined
	 * DTD in a DOCTYPE element.
	 */
	public static final int INTERNAL_DTD_INTERNAL = -5;
	
	/**
	 * Token type specific to XMLTokenMaker denoting a line ending with an unclosed comment. The
	 * state to return to when this comment ends is embedded in the token type as well.
	 */
	...
	/**
	 * Whether the DTD we're currently in is a locally-defined one. This field is only valid when in
	 * a DOCTYPE element (the <DTD> state).
	 */
	private boolean inInternalDtd;
	
	/**
	 * The state we were in prior to the current one. This is used to know what state to resume
	 * after an MLC ends.
	 */
	...
	/**
	 * Returns whether markup close tags should be completed. For XML, the default value is
	 * <code>true</code>.
	 *
	...
	/**
	 * Static version of {@link #getCompleteCloseTags()}. This hack is unfortunately needed for
	 * applications to be able to query this value without instantiating this class.
	 *
	 * @return Whether closing markup tags are completed.
	 * @see #setCompleteCloseTags(boolean)
	 */
