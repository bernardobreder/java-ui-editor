/*
 * 07/31/2009 ExtendedHyeprlinkListener.java - A hyperlink event from a FocusableTip. This library
...
/**
 * Listens for hyperlink events from {@link FocusableTip}s. In addition to the link event, the text
 * area that the tip is for is also received, which allows the listener to modify the displayed
 * content, if desired.
 *
