...
/**
 * Wrapper for a tool tip and a listener for hyperlink events in the tool tip (assuming the tip is
 * HTML). If the {@link RSyntaxTextArea} instance has {@link FocusableTip}s enabled, and the user
 * clicks on a hyperlink in the tool tip, the specified {@link HyperlinkListener} will be called.
 *
...
public class ToolTipInfo {
	 ...
	 * @param imageBase The base URL for images in the HTML <code>text</code>, or <code>null</code>
	 *            for the default.
	 */
	...
	/**
	 * Returns the base URL that any images in the HTML tool tip live in. This allows you to
	 * reference images in a jar file in your {@link FocusableTip}s. Note that if what
	 * {@link #getToolTipText()} returns isn't HTML, this value is effectively ignored.
	 *
