...
/**
 * Interface for classes that paint the background of an <code>RTextAreaBase</code>. The Strategy
 * pattern is used for this object because the background can be painted as a solid color, as an
 * image, and possibly other ways (gradients, animated images, etc.). When a method to change the
 * background of an <code>RTextAreaBase</code> instance is called (such as
 * <code>setBackground</code>, <code>setBackgroundImage</code> or <code>setBackgoundObject</code>),
