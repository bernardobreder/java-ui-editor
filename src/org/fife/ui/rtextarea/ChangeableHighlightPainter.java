...
/**
 * An extension of <code>LayerPainter</code> that allows the user to change several of its
 * properties:
 * <ul>
 * <li>Its color/fill style (can use a <code>GradientPaint</code>, for example).</li>
...
public class ChangeableHighlightPainter extends LayeredHighlighter.LayerPainter implements Serializable {
	 ...
	 * <code>0.0f</code> (completely invisible) to <code>1.0f</code> (completely opaque).
	 */
	private float alpha;
	...
	/**
	 * Creates a new <code>ChangableHighlightPainter</code> that paints highlights with the text
	 * area's selection color (i.e., behaves exactly like
	...
	/**
	 * Creates a new highlight painter using the specified <code>Paint</code> without rounded edges.
	 *
	 * @param paint The <code>Paint</code> (usually a <code>java.awt.Color</code>) with which to
	 ...
	 *            paint the highlights.
	 * @param rounded Whether to use rounded edges on the highlights.
	 * @param alpha The alpha value to use when painting highlights. This value should be in the
	 *            range <code>0.0f</code> (completely transparent) through <code>1.0f</code>
	 *            (opaque).
	 */
	...
	/**
	 * Returns the alpha value used in computing the translucency of these highlights. A value of
	 * <code>1.0f</code> (the default) means that no translucency is used; there is no performance
	 * hit for this value. For all other values (<code>[0.0f..1.0f)</code>), there will be a
	 * performance hit.
	 *
	...
	/**
	 * Returns the <code>Paint</code> (usually a <code>java.awt.Color</code>) being used to paint
	 * highlights.
	 *
	...
	/**
	 * Sets the alpha value used in rendering highlights. If this value is <code>1.0f</code> (the
	 * default), the highlights are rendered completely opaque. This behavior matches that of
	 * <code>DefaultHighlightPainter</code> and imposes no performance hit. If this value is below
	 * <code>1.0f</code>, it represents how opaque the highlight will be. There will be a small
	...
	/**
	 * Sets the <code>Paint</code> (usually a <code>java.awt.Color</code>) used to paint this
	 * highlight.
	 *
