...
/**
 * A popup window that displays the most recent snippets added to the clipboard of an
 * <code>RSyntaxTextArea</code>. Selecting one pastes that snippet.
 *
...
class ClipboardHistoryPopup extends JWindow {
	...
	public ClipboardHistoryPopup(Window parent, RTextArea textArea) {
		...
		cp.setBorder(BorderFactory.createCompoundBorder(org.fife.ui.rsyntaxtextarea.focusabletip.TipUtil.getToolTipBorder(), BorderFactory.createEmptyBorder(2, 5, 5, 5)));
	 ...
	 *
	 * @param visible Whether this popup window was just made visible (as opposed to hidden).
	 */
	...
	/**
	 * Entries in the choices list are of this type. This truncates entries that are too long. In
	 * the future it can provide more information (line count for multi-line pastes, etc.).
	 */
