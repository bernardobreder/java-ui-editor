...
/**
 * Component in the gutter that displays +/- icons to expand and collapse fold regions in the
 * editor.
 *
...
public class FoldIndicator extends AbstractGutterComponent {
	...
	/**
	 * Overridden to use the editor's background if it's detected that the user isn't using white as
	 * the editor bg, but the system's tool tip background is yellow-ish.
	 *
	 * @return The tool tip.
	 */
	@Override
	...
	/**
	 * Returns the color to use for the "background" of fold icons. This is be ignored if custom
	 * icons are used.
	 *
	...
	/**
	 * Positions tool tips to be aligned in the text component, so that the displayed content is
	 * shown (almost) exactly where it would be in the editor.
	 *
	...
	/**
	 * Sets the color to use for the "background" of fold icons. This will be ignored if custom
	 * icons are used.
	 *
