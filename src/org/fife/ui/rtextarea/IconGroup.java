/*
 * 09/05/2004 IconGroup.java - Class encapsulating images used for RTextArea actions. This library
...
/**
 * This class encapsulates the location, properties, etc. of an icon set used for an instance of
 * <code>RTextArea</code>. If the location of the icon group is invalid in any way, any attempt to
 * retrieve icons from an icon group will return <code>null</code>.
 *
...
public class IconGroup {
	 ...
	 * @param name The name of the icon group.
	 * @param path The directory containing the icon group.
	 * @param largeIconSubDir The subdirectory containing "large versions" of the icons. If no
	 ...
	 * @param largeIconSubDir The subdirectory containing "large versions" of the icons. If no
	 *            subdirectory exists, pass in <code>null</code>.
	 * @param extension The extension of the icons (one of <code>gif</code>, <code>jpg</code>, or
	 *            <code>png</code>).
	 */
	 ...
	 * @param extension The extension of the icons (one of <code>gif</code>, <code>jpg</code>, or
	 *            <code>png</code>).
	 * @param jar The Jar file containing the icons, or <code>null</code> if the icons are on the
	 *            local file system. If a Jar is specified, the value of <code>path</code> must be a
	 *            path in the Jar file. If this is not a valid Jar file, then no Jar file will be
	 *            used, meaning all icons returned from this icon group will be <code>null</code>.
	 */
	 ...
	 *
	 * @param name The name of the icon. For example, if you want the icon specified in
	 *            <code>new.gif</code>, this value should be <code>new</code>.
	 ...
	 *
	 * @param iconFullPath The full path to the icon, either on the local file system or in the Jar
	 *            file, if this icon group represents icons in a Jar file.
	 * @return The icon.
	 */
	...
	/**
	 * Returns the large icon from this icon group with the specified name. If this icon group does
	 * not have large icons, <code>null</code> is returned.
	 *
	 * @param name The name of the icon. For example, if you want the icon specified in
	 *            <code>new.gif</code>, this value should be <code>new</code>.
	 * @return The icon, or <code>null</code> if it could not be found or loaded.
	...
	/**
	 * Overridden since we also override {@link #equals(Object)}, to honor the invariant that equal
	 * objects must have equal hashcodes. This also keeps FindBugs happy.
	 */
	@Override
	public int hashCode() {
