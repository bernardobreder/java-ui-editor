 ...
 * <p>
 * A <code>java.awt.image.VolatileImage</code> is used for rendering; theoretically, this should be
 * the best image format for performance.
 * <p>
...
public class VolatileImageBackgroundPainterStrategy extends ImageBackgroundPainterStrategy {
	...
	/**
	 * Renders the image at the proper size into <code>bgImage</code>. This method assumes that
	 * <code>bgImage</code> is not <code>null</code>.
	 *
